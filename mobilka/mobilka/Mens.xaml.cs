...
namespace mobilka
{
    ...
    public partial class Mens : ContentPage
    {
        ...
        {
            MensKurtki mensKurtki = new MensKurtki(this.userId);
            Navigation.PushModalAsync(new NavigationPage(mensKurtki));
        }
        private void ImageButton_Clicked2(object sender, EventArgs e)
        {
            MensShtani mensShtani = new MensShtani(this.userId);
            Navigation.PushModalAsync(new NavigationPage(mensShtani ));
        }
        private void ImageButton_Clicked3(object sender, EventArgs e)
        {
            MenTShirtsPage menTShirtsPage = new MenTShirtsPage(this.userId);
            Navigation.PushModalAsync(new NavigationPage(menTShirtsPage));
        }
        private void ImageButton_Clicked4(object sender, EventArgs e)
        {
            MensKofta mensKofta = new MensKofta(this.userId);
            Navigation.PushModalAsync(new NavigationPage(mensKofta));
        }
